...
Kahveler: {
  "Soğuk Kahveler": [
    { name: "Buzlu kahve", price: "₺150", description: "Espresso, kahve, süt ve buz ile hazırlanır." },
    { name: "Buzlu sütlü kahve", price: "₺160", description: "Soğuk sütle hazırlanan buzlu kahve." },
    { name: "Aromalı buzlu kahve", price: "₺165", description: "Çilek, fındık, vanilya, badem, karamel, muz, kavun aromalarıyla hazırlanır." },
    { name: "Frappeler", price: "₺150", description: "Süt, buz parçacıkları, meyve püresi, kahve ve meyve konsantresi ile hazırlanır. Çilekli - Çikolatalı - Vanilyalı - Kavunlu - Kivili - Muzlu - Ananaslı - Böğürtlenli - Kırmızı Orman Meyveli - Şeftalili " },
  ],
  ...
  Tatlılar: {
    "Pastalar & Diğer Tatlılar": [
      { name: "Adet Pasta", price: "₺230", description: "Çikolatalı, Fıstık Drajeli, Meyveli" },
      { name: "Malaga Pasta", price: "₺200", description: "" },
      { name: "Bubble Waffle", price: "₺250", description: "" },
      { name: "San Sebastian Cheesecake", price: "₺200", description: "" },
      { name: "Şeffaf Çilek", price: "₺175", description: "" },
      { name: "Sufle", price: "₺150", description: "" },
